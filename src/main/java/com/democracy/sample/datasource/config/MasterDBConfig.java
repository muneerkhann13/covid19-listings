package com.democracy.sample.datasource.config;
...
@EnableJpaRepositories(entityManagerFactoryRef = "masterEntityManagerFactory",
		...
		basePackages = { "com.democracy.sample.datasource.repository.master" })
...
public class MasterDBConfig {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory(EntityManagerFactoryBuilder builder,
		...
		return builder.dataSource(dataSource)
				...
				.packages("com.democracy.sample.datasource.model").properties(jpaProperties()).build();
	}
